...
namespace Sofa.CourseManagement.EntityFramework.Migrations
{
    ...
    [Migration("20201207150655_12-7-2020-1")]
    partial class _12720201
    {
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AgeRange = 2,
                            CreateDate = new DateTime(2020, 12, 7, 18, 36, 54, 827, DateTimeKind.Local).AddTicks(6010),
                            Description = "",
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.Field", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 12, 7, 18, 36, 54, 826, DateTimeKind.Local).AddTicks(8099),
                            Description = "",
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.Institute", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "7e042a43-c35f-4e19-8ab2-c04a7e02ae9c",
                            CreateDate = new DateTime(2020, 12, 7, 18, 36, 54, 825, DateTimeKind.Local).AddTicks(9360),
                            Description = "51eb93fa-c343-42c9-a775-9aeecf79f2aa",
                            IsActive = true,
                            IsDeleted = false,
                            ModifyDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            RowVersion = 0,
                            Title = "TestInstitute",
                            WebsiteUrl = "025e5dc2-1a9c-4158-85ce-59c6d08b14f1"
                        });
                });
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.LessonPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 12, 7, 18, 36, 54, 829, DateTimeKind.Local).AddTicks(1412),
                            Description = "",
                            IsActive = true,
                            IsDeleted = false,
                            Level = 0,
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContentType = 0,
                            CreateDate = new DateTime(2020, 12, 7, 18, 36, 54, 830, DateTimeKind.Local).AddTicks(6716),
                            Description = "",
                            IsActive = true,
                            IsDeleted = false,
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.Session", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 12, 7, 18, 36, 54, 829, DateTimeKind.Local).AddTicks(7413),
                            Description = "",
                            IsActive = true,
                            IsDeleted = false,
                            LessonPlanId = new Guid("0908ec03-9f07-426a-a26c-78cac8646545"),
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.Term", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 12, 7, 18, 36, 54, 828, DateTimeKind.Local).AddTicks(4111),
                            Description = "",
                            IsActive = true,
                            IsDeleted = false,
                            ModifyDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 12, 7, 18, 36, 54, 788, DateTimeKind.Local).AddTicks(4406),
                            Description = "",
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 12, 7, 18, 36, 54, 801, DateTimeKind.Local).AddTicks(8722),
                            Description = "",
                            Email = "jahanbin.ali1988@gmail.com",
                            FirstName = "Ali",
                            IsActive = true,
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 12, 7, 18, 36, 54, 812, DateTimeKind.Local).AddTicks(7963),
                            Description = "",
                            Email = "jahanbin.ali1988@gmail.com",
                            FirstName = "Ali",
                            IsActive = true,
