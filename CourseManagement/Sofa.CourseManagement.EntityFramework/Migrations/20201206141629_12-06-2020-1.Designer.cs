...
namespace Sofa.CourseManagement.EntityFramework.Migrations
{
    ...
    [Migration("20201206141629_12-06-2020-1")]
    partial class _120620201
    {
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AgeRange = 2,
                            CreateDate = new DateTime(2020, 12, 6, 17, 46, 28, 290, DateTimeKind.Local).AddTicks(310),
                            Description = "",
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.Field", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 12, 6, 17, 46, 28, 289, DateTimeKind.Local).AddTicks(3237),
                            Description = "",
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.Institute", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "a5104a54-00a8-4ab7-8b88-dfd12d13668e",
                            CreateDate = new DateTime(2020, 12, 6, 17, 46, 28, 288, DateTimeKind.Local).AddTicks(4419),
                            Description = "49685659-8124-4475-84f2-b3f031383dfc",
                            IsActive = true,
                            IsDeleted = false,
                            ModifyDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            RowVersion = 0,
                            Title = "TestInstitute",
                            WebsiteUrl = "3b6b930f-63b9-44c1-8da7-a3dbb4421413"
                        });
                });
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.LessonPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 12, 6, 17, 46, 28, 291, DateTimeKind.Local).AddTicks(6629),
                            Description = "",
                            IsActive = true,
                            IsDeleted = false,
                            Level = 0,
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContentType = 0,
                            CreateDate = new DateTime(2020, 12, 6, 17, 46, 28, 293, DateTimeKind.Local).AddTicks(820),
                            Description = "",
                            IsActive = true,
                            IsDeleted = false,
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.Session", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 12, 6, 17, 46, 28, 292, DateTimeKind.Local).AddTicks(2085),
                            Description = "",
                            IsActive = true,
                            IsDeleted = false,
                            LessonPlanId = new Guid("0908ec03-9f07-426a-a26c-78cac8646545"),
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.Term", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 12, 6, 17, 46, 28, 290, DateTimeKind.Local).AddTicks(8817),
                            Description = "",
                            IsActive = true,
                            IsDeleted = false,
                            ModifyDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 12, 6, 17, 46, 28, 230, DateTimeKind.Local).AddTicks(5040),
                            Description = "",
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 12, 6, 17, 46, 28, 270, DateTimeKind.Local).AddTicks(7006),
                            Description = "",
                            Email = "jahanbin.ali1988@gmail.com",
                            FirstName = "Ali",
                            IsActive = true,
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 12, 6, 17, 46, 28, 279, DateTimeKind.Local).AddTicks(5766),
                            Description = "",
                            Email = "jahanbin.ali1988@gmail.com",
                            FirstName = "Ali",
                            IsActive = true,
