...
namespace Sofa.CourseManagement.EntityFramework.Migrations
{
    ...
    [Migration("20201006110031_10062020-1")]
    partial class _100620201
    {
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AgeRange = 2,
                            CreateDate = new DateTime(2020, 10, 6, 14, 30, 30, 659, DateTimeKind.Local).AddTicks(3468),
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.Field", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 10, 6, 14, 30, 30, 658, DateTimeKind.Local).AddTicks(8119),
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.Institute", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "65479c12-0fbc-4c78-862a-1872a4021797",
                            CreateDate = new DateTime(2020, 10, 6, 14, 30, 30, 658, DateTimeKind.Local).AddTicks(1996),
                            IsActive = true,
                            IsDeleted = false,
                            ModifyDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            RowVersion = 0,
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContentType = 0,
                            CreateDate = new DateTime(2020, 10, 6, 14, 30, 30, 661, DateTimeKind.Local).AddTicks(4878),
                            Description = "",
                            IsActive = true,
                            IsDeleted = false,
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.Session", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 10, 6, 14, 30, 30, 660, DateTimeKind.Local).AddTicks(7220),
                            Description = "",
                            IsActive = true,
                            IsDeleted = false,
                            LessonPlanId = new Guid("0908ec03-9f07-426a-a26c-78cac8646545"),
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.Term", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 10, 6, 14, 30, 30, 659, DateTimeKind.Local).AddTicks(8310),
                            Description = "",
                            IsActive = true,
                            IsDeleted = false,
                            ModifyDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 10, 6, 14, 30, 30, 640, DateTimeKind.Local).AddTicks(5273),
                            Description = "",
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 10, 6, 14, 30, 30, 649, DateTimeKind.Local).AddTicks(4077),
                            Description = "",
                            Email = "jahanbin.ali1988@gmail.com",
                            FirstName = "Ali",
                            IsActive = true,
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 10, 6, 14, 30, 30, 657, DateTimeKind.Local).AddTicks(8354),
                            Description = "",
                            Email = "jahanbin.ali1988@gmail.com",
                            FirstName = "Ali",
                            IsActive = true,
