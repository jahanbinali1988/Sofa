...
namespace Sofa.CourseManagement.EntityFramework.Migrations
{
    ...
    [Migration("20200919121836_09192020-1")]
    partial class _091920201
    {
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.Institute", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("73400994-2d74-49b7-ba3e-fcfad82ec45e"),
                            CreateDate = new DateTime(2020, 9, 19, 16, 48, 34, 732, DateTimeKind.Local).AddTicks(3413),
                            IsActive = true,
            ...
            modelBuilder.Entity("Sofa.CourseManagement.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 9, 19, 16, 48, 34, 698, DateTimeKind.Local).AddTicks(7012),
                            Description = "",
                            ...
                            LastName = "Jahanbin",
                            Level = 2,
                            ModifyDate = new DateTime(2020, 9, 19, 16, 48, 34, 699, DateTimeKind.Local).AddTicks(979),
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 9, 19, 16, 48, 34, 713, DateTimeKind.Local).AddTicks(8014),
                            Description = "",
                            ...
                            LastName = "Jahanbin",
                            Level = 2,
                            ModifyDate = new DateTime(2020, 9, 19, 16, 48, 34, 713, DateTimeKind.Local).AddTicks(8167),
                            PasswordHash = "JB661pQ8yCirbaGKuNu8wIZjd7/lq74u5bDYUaX6GW0=",
                            PhoneNumber = "09224957626",
                            Role = 1,
                            RowVersion = 0,
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2020, 9, 19, 16, 48, 34, 722, DateTimeKind.Local).AddTicks(6282),
                            Description = "",
                            ...
                            LastName = "Jahanbin",
                            Level = 0,
                            ModifyDate = new DateTime(2020, 9, 19, 16, 48, 34, 722, DateTimeKind.Local).AddTicks(6303),
                            PasswordHash = "JB661pQ8yCirbaGKuNu8wIZjd7/lq74u5bDYUaX6GW0=",
                            PhoneNumber = "09224957626",
                            Role = 1,
                            RowVersion = 0,
