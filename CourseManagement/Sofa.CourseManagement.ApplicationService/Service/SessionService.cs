    ...
    public class SessionService : ISessionService
    {
        ...
        public AddSessionResponse AddSession(AddSessionRequest request)
        {
            try
            {
                ...
                var session = Session.CreateInstance(null, request.Title, request.LessonPlanId, request.TermId, request.IsActive, request.Description);
        ...
        public UpdateSessionResponse Update(UpdateSessionRequest request)
        {
            try
            {
                ...
                var session = Session.CreateInstance(request.Id, request.Title, request.LessonPlanId, request.TermId, request.IsActive, request.Description);
